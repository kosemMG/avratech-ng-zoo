(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BirdsCardComponent = /** @class */ (function () {
                function BirdsCardComponent(birdsService, route) {
                ...
                BirdsCardComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    setTimeout(function () {
                        _this.birdsService.currentAnimal = _this.getBird();
                        _this.route.params
                            .subscribe(function () {
                            _this.birdsService.currentAnimal = _this.getBird();
                        });
                ...
                BirdsCardComponent.prototype.getBird = function () {
                    var birdId = +this.route.snapshot.params.id;
                    for (var _i = 0, _a = this.birdsService.list; _i < _a.length; _i++) {
                        var bird = _a[_i];
                        if (bird.id === birdId) {
                            return bird;
                        }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var LivestockCardComponent = /** @class */ (function () {
                function LivestockCardComponent(livestockService, route) {
                    this.livestockService = livestockService;
                    this.route = route;
                    console.log('LivestockCardComponent constructor()');
                }
                LivestockCardComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    setTimeout(function () {
                        _this.livestockService.currentAnimal = _this.getBird();
                        _this.route.params
                            .subscribe(function () {
                            _this.livestockService.currentAnimal = _this.getBird();
                        });
                ...
                LivestockCardComponent.prototype.getBird = function () {
                    var birdId = +this.route.snapshot.params.id;
                    for (var _i = 0, _a = this.livestockService.list; _i < _a.length; _i++) {
                        var bird = _a[_i];
                        if (bird.id === birdId) {
                            return bird;
                        }
                ...
                return LivestockCardComponent;
            }());
            LivestockCardComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var WildAnimalsCardComponent = /** @class */ (function () {
                function WildAnimalsCardComponent(wildService, route) {
                    this.wildService = wildService;
                    this.route = route;
                    console.log('WildAnimalsCardComponent constructor()');
                }
                WildAnimalsCardComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    setTimeout(function () {
                        _this.wildService.currentAnimal = _this.getBird();
                        _this.route.params
                            .subscribe(function () {
                            _this.wildService.currentAnimal = _this.getBird();
                        });
                ...
                WildAnimalsCardComponent.prototype.getBird = function () {
                    var birdId = +this.route.snapshot.params.id;
                    for (var _i = 0, _a = this.wildService.list; _i < _a.length; _i++) {
                        var bird = _a[_i];
                        if (bird.id === birdId) {
                            return bird;
                        }
                ...
                return WildAnimalsCardComponent;
            }());
            WildAnimalsCardComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PaginatorComponent = /** @class */ (function () {
                function PaginatorComponent(route, birdsService, livestockService, wildService) {
                    this.route = route;
                    this.birdsService = birdsService;
                    this.livestockService = livestockService;
                    this.wildService = wildService;
                ...
                PaginatorComponent.prototype.ngOnInit = function () {
                    ...
                    setTimeout(function () {
                        ...
                        _this.route.params
                            ...
                            _this.path = '/' + _this.getPanel();
                            _this.id = +params.id;
                            _this.serCurrentAnimalsArrayLength();
                        });
                    });
                };
                PaginatorComponent.prototype.serCurrentAnimalsArrayLength = function () {
                    switch (this.path) {
                        case '/birds':
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BirdsPanelComponent = /** @class */ (function () {
                function BirdsPanelComponent(birdsService) {
                    this.birdsService = birdsService;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _services_livestock_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/livestock.service */ "./src/app/services/livestock.service.ts");
            var LivestockPanelComponent = /** @class */ (function () {
                function LivestockPanelComponent(livestockService) {
                    this.livestockService = livestockService;
                    console.log('LivestockPanelComponent constructor()');
                }
                LivestockPanelComponent.prototype.navigateTo = function (animal) {
                ...
                return LivestockPanelComponent;
            }());
            LivestockPanelComponent.ctorParameters = function () { return [
                { type: _services_livestock_service__WEBPACK_IMPORTED_MODULE_2__["LivestockService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _services_wild_animals_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/wild-animals.service */ "./src/app/services/wild-animals.service.ts");
            var WildAnimalsPanelComponent = /** @class */ (function () {
                function WildAnimalsPanelComponent(wildService) {
                    this.wildService = wildService;
                    console.log('WildAnimalsPanelComponent constructor()');
                }
                WildAnimalsPanelComponent.prototype.navigateTo = function (animal) {
                ...
                return WildAnimalsPanelComponent;
            }());
            WildAnimalsPanelComponent.ctorParameters = function () { return [
                { type: _services_wild_animals_service__WEBPACK_IMPORTED_MODULE_2__["WildAnimalsService"] }
            ]; };
            ...
            var BirdsService = /** @class */ (function () {
                function BirdsService(http) {
                    ...
                    this.http.get('https://raw.githubusercontent.com/kosemMG/avratech-ng-zoo/master/src/assets/json/birds.json')
                        ...
                        _this.list = data;
                        _this.currentAnimal = _this.list[0];
                    });
                }
                return BirdsService;
            }());
            BirdsService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var LivestockService = /** @class */ (function () {
            ...
            LivestockService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var WildAnimalsService = /** @class */ (function () {
                function WildAnimalsService(http) {
                    var _this = this;
                    this.http = http;
                    this.list = [];
                    this.currentIndex = 0;
                ...
                return WildAnimalsService;
            }());
            WildAnimalsService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
